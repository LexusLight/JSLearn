...
import Timer from './lessons/mobx/timer'
//states
// import {TimerMobX} from './lessons/mobx/timerstate'
// import myTimer from "./lessons/mobx/timerstate";
      ...
      <div>
              <BrowserRouter>
                  <ul>
                      ...
                      <li><NavLink to={'/mobxtimer'}>mobx таймер</NavLink></li>
                  ...
                  <Route path={'/mobxtimer'}><Timer/></Route>
              </BrowserRouter>
